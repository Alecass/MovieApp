...
public class FilmProvider extends ContentProvider {
    ...
    public static final String MIME_TYPE_ORDERS = ContentResolver.CURSOR_DIR_BASE_TYPE + "vnd.all_films";
    public static final String MIME_TYPE_ORDER = ContentResolver.CURSOR_ITEM_BASE_TYPE + "vnd.single_film";
    ...
    static {
        uriMatcher.addURI(AUTORITY, BASE_PATH_FILMS, ALL_FILMS);
